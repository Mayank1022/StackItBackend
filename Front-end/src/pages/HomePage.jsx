...
// Mock data for questions (expanded for pagination)
  ...
  const baseQuestions = [
    {
      ...
      description:
        "I'm trying to set up JWT authentication in my Next.js application but running into issues with token storage and validation...",
    ...
    },
    {
      ...
      description: "My PostgreSQL queries are running slowly. What are some techniques to optimize performance?",
      author: { name: "Mike Chen", avatar: "/placeholder.svg?height=32&width=32" },
    ...
    },
    {
      ...
      description: "I'm struggling to understand TypeScript generics. Can someone provide practical examples?",
    ...
    },
    {
      ...
      description: "I'm confused about when to use CSS Grid versus Flexbox. What are the best use cases for each?",
